...
app.post('/recipegeneration', urlencodedParser, function (req, res) {

    var LowBloodSugarRecipe = {
        recipe: "Beef and Cabbage Stew (with Rice)", 
        one: "Beef", 
        two: "Rice", 
        three: "Bread", 
        four: "Cabbage",
    ...
    var HighBloodSugarRecipe = {
        recipe: "Scrambled eggs with smoked mackerel & chives", 
        one: "Mackerel", 
        two: "Garlic", 
        three: "Spinach", 
        four: "Blueberries",
    ...
    if (req.body.bloodGlucose > 100) {
        console.log("Recipe Generated for High");
        res.render('index', {recipe: HighBloodSugarRecipe, sugar: req.body.bloodGlucose});
    } else {
        console.log("Recipe Generated for Low");
        res.render('index', {recipe: LowBloodSugarRecipe, sugar: req.body.bloodGlucose});
    }
